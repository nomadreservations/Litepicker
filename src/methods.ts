...
Litepicker.prototype.getStartDate = function (): Date {
    if (this.options.startDate) {
        const castedObj = this.options.startDate.clone() as DateTimeParser;
...
Litepicker.prototype.getEndDate = function (): Date {
    if (this.options.endDate) {
        const castedObj = this.options.endDate.clone() as DateTimeParser;
        return castedObj.getDateInstance();
    }
...
Litepicker.prototype.gotoDate = function (date, idx = 0) {
    const toDate = new DateTimeParser(date);
    toDate.setDate(1);
...
Litepicker.prototype.setOptions = function (options) {
    ...
    if (options.startDate) {
        options.startDate = new DateTimeParser(
            options.startDate,
            this.options.format,
            this.options.lang
        );
    ...
    if (options.endDate) {
        options.endDate = new DateTimeParser(
            options.endDate,
            this.options.format,
            this.options.lang
        );
